...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 21 oct. 2021 à 22:08
...
(1, 4, '2021-10-21 00:00:00'),
(1, 5, '2021-10-21 00:00:00'),
(1, 8, '2021-10-21 00:00:00'),
(3, 10, '2021-10-21 00:00:00'),
(4, 4, '2021-10-21 00:00:00');
...
(4, 'Test2', 'Test with image', '100.0000', '70.0000', '80.0000', '3.3000', '2021-10-30 00:00:00', '5.0000', 1, 1, 1, 6, 'Vendu'),
(5, 'test3', 'test with 2 images', '200000.0000', '1000.0000', '1400.2300', '5.6000', '2021-10-23 00:00:00', '100.0000', 1, 1, 2, 13, 'Vendu'),
(8, 'Feuille', 'Une feuille', '24.7000', '500.0000', '23.8000', '3.9700', '2021-10-13 00:00:00', '50.0000', 1, 2, 2, 13, 'Vendu'),
(10, 'Ordinateur', 'Bon état, non utilisé', '2000.0000', '3000.0000', '2500.0000', '10.0000', '2021-10-23 00:00:00', '300.0000', 1, 5, 1, 6, 'Vendu'),
(11, 'IPAD', 'Bon état', '2000.0000', '2500.0000', '2500.0000', '35.0000', '2021-10-24 00:00:00', '250.0000', 3, 4, 1, 6, 'encours d\'enchère');
...
INSERT INTO `encherir` (`idmembre`, `idarticle`, `nombrePas`, `ifGagnant`, `prixPropose`, `dateEncherir`) VALUES
(1, 4, 4, 0, '70.0000', '2021-10-21 00:00:00'),
(1, 5, 2, 0, '1200.0000', '2021-10-21 00:00:00');
...
(1, 'Cussat', 'Blanc', '2020-01-27 22:11:50', 'c@gmail.com', '20 rue', '31400', 'Toulouse', 'France', '12345678', 'membre', 0),
(3, 'BAH', 'Maimouna', '2020-08-16 16:54:57', 'm@gmail.com', '17 av', '31400', 'Toulouse', 'France', '12345678', 'membre', 0),
...
INSERT INTO `posseder` (`idimage`, `idarticle`) VALUES
(2, 4),
(2, 5),
(4, 5),
(9, 8),
...
ALTER TABLE `achatimmediat`
  ADD CONSTRAINT `FK_achatImmediat_article` FOREIGN KEY (`idArticle`) REFERENCES `article` (`idarticle`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_achatImmediat_membre` FOREIGN KEY (`idMembre`) REFERENCES `membre` (`idmembre`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `article`
--
ALTER TABLE `article`
  ADD CONSTRAINT `FK_article_cat` FOREIGN KEY (`idCategorie`) REFERENCES `categorie` (`idCategorie`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_article_regionLiv` FOREIGN KEY (`idRegionLiv`) REFERENCES `regionlivraison` (`idregionlivraison`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_article_sousCat` FOREIGN KEY (`idSousCategorie`) REFERENCES `categorie` (`idCategorie`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_article_vendeur` FOREIGN KEY (`idvendeur`) REFERENCES `membre` (`idmembre`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `avisarticle`
--
ALTER TABLE `avisarticle`
  ADD CONSTRAINT `FK_avisarticle_article` FOREIGN KEY (`idarticle`) REFERENCES `article` (`idarticle`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_avisarticle_membre` FOREIGN KEY (`idmembre`) REFERENCES `membre` (`idmembre`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `avismembre`
--
ALTER TABLE `avismembre`
  ADD CONSTRAINT `FK_avismembre_emis` FOREIGN KEY (`idmembreEmis`) REFERENCES `membre` (`idmembre`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_avismembre_recu` FOREIGN KEY (`idmembreRecu`) REFERENCES `membre` (`idmembre`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `castat`
--
ALTER TABLE `castat`
  ADD CONSTRAINT `FK_castat_cat` FOREIGN KEY (`idCategorie`) REFERENCES `categorie` (`idCategorie`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `choisir`
--
ALTER TABLE `choisir`
  ADD CONSTRAINT `FK_choisir_membre` FOREIGN KEY (`idmembre`) REFERENCES `membre` (`idmembre`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_choisir_prestation` FOREIGN KEY (`idprestation`) REFERENCES `prestation` (`idPRESTATION`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `composer`
--
ALTER TABLE `composer`
  ADD CONSTRAINT `FK_composer_cat` FOREIGN KEY (`idCategorie`) REFERENCES `categorie` (`idCategorie`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_composer_souscat` FOREIGN KEY (`idSousCategorie`) REFERENCES `categorie` (`idCategorie`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `composersous`
--
ALTER TABLE `composersous`
  ADD CONSTRAINT `FK_composerS_souscat` FOREIGN KEY (`idSousCategorie`) REFERENCES `categorie` (`idCategorie`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_composerS_ssouscat` FOREIGN KEY (`idSSousCategorie`) REFERENCES `categorie` (`idCategorie`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `encherir`
--
ALTER TABLE `encherir`
  ADD CONSTRAINT `FK_encherir_article` FOREIGN KEY (`idarticle`) REFERENCES `article` (`idarticle`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_encherir_membre` FOREIGN KEY (`idmembre`) REFERENCES `membre` (`idmembre`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `nostat`
--
ALTER TABLE `nostat`
  ADD CONSTRAINT `FK_nostat_cat` FOREIGN KEY (`idCategorie`) REFERENCES `categorie` (`idCategorie`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `posseder`
--
ALTER TABLE `posseder`
  ADD CONSTRAINT `FK_posseder_article` FOREIGN KEY (`idarticle`) REFERENCES `article` (`idarticle`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_posseder_image` FOREIGN KEY (`idimage`) REFERENCES `image` (`idimage`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Contraintes pour la table `visstat`
--
ALTER TABLE `visstat`
  ADD CONSTRAINT `FK_visstat_cat` FOREIGN KEY (`idCategorie`) REFERENCES `categorie` (`idCategorie`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
